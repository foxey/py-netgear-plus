...
<tr><td class="paddingTableBody" colspan='2'><table class="tableStyle" id="tbl2" style="width:728px;">
 ...
 <tr>
  ...
  <input untrans type="text" name="switch_name" id="switch_name" value="SCHREIBTISCH" size="15" maxlength="20" onmousedown="enableImage();" onkeypress="enableImage();" />
 </td></tr>
 <tr>
  <td class="padding14Top">ss091</td>
  <td  align="center" nowrap>4851585L00415</td>
 </tr>
 <tr>
  <td class="padding14Top">ss009</td>
  <td  align="center" nowrap>A0:63:91:97:A1:3C</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>
  <input type="text" name="ip_address" id="ip_address" value="192.168.178.253" size="15" maxlength="15" onmousedown="enableImage();" onkeypress="enableImage();">
  </td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td  align="center" nowrap>
  <input type="text" name="gateway_address" id="gateway_address" value="192.168.178.1" size="15" maxlength="15" onmousedown="enableImage();" onkeypress="enableImage();">
  </td>
 </tr>
